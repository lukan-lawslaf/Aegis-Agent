...
export const ModelSettings = ({ isDarkMode = false }: ModelSettingsProps) => {
  ...
  const renderModelSelect = (agentName: AgentNameEnum) => (
    <div
      ...
      <h3 className={`mb-2 text-lg font-medium ${isDarkMode ? 'text-secondary' : 'text-primary'}`}>
        {agentName.charAt(0).toUpperCase() + agentName.slice(1)}
      </h3>
      <p className={`mb-4 text-sm font-normal ${isDarkMode ? 'text-tertiary' : 'text-secondary'}`}>
      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center">
          <label
            ...
            className={`w-24 text-sm font-medium ${isDarkMode ? 'text-secondary' : 'text-primary'}`}>
            {t('options_models_labels_model')}
          </label>
          <select
            id={`${agentName}-model`}
            className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-strong bg-elevated text-primary' : 'border-strong bg-surface text-primary'} px-3 py-2`}
          ...
          <div className="flex items-center">
            ...
            <div className="flex flex-1 items-center space-x-2">
              <input
                ...
                className={`flex-1 'accent-[var(--c-accent)]' h-1 appearance-none rounded-full`}
              />
              <div className="flex items-center space-x-2">
                <span className={`w-12 text-sm 'text-secondary'`}>
                ...
                <input
                  ...
                  className={`w-20 rounded-md border ${isDarkMode ? 'border-strong bg-elevated text-primary focus:border-accent focus:ring-2 focus:ring-accent' : 'border-strong bg-surface text-primary focus:border-accent focus:ring-2 focus:ring-accent'} px-2 py-1 text-sm`}
  ...
  return (
    <section className="space-y-6">
      ...
      <div
        className={`rounded-lg border ${'border-subtle bg-surface'} p-6 text-left`}>
            ...
            getSortedProviders().map(([providerId, providerConfig]) => {
              ...
              return (
                <div
                  ...
                  className={`space-y-4 ${modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) ? `rounded-lg border p-4 'border-accent bg-accent-soft'` : ''}`}>
                  <div className="flex items-center justify-between">
                    <h3 className={`text-lg font-medium ${isDarkMode ? 'text-secondary' : 'text-primary'}`}>
                  ...
                  <div className="space-y-3">
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center">
                          <label
                            ...
                            className={`w-20 text-sm font-medium ${isDarkMode ? 'text-secondary' : 'text-primary'}`}>
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border p-2 text-sm ${
                              nameErrors[providerId]
                                ? isDarkMode
                                  ? 'border-red-700 bg-elevated text-primary focus:border-red-600 focus:ring-2 focus:ring-red-900'
                                  : 'border-red-300 bg-subtle focus:border-red-400 focus:ring-2 focus:ring-red-200'
                                : isDarkMode
                                  ? 'border-accent bg-elevated text-primary focus:border-accent focus:ring-2 focus:ring-accent'
                                  : 'border-strong bg-subtle focus:border-accent focus:ring-2 focus:ring-accent'
                            } outline-none`}
                          />
                        </div>
                        {nameErrors[providerId] ? (
                          ...
                          <p className={`ml-20 mt-1 text-xs ${isDarkMode ? 'text-tertiary' : 'text-secondary'}`}>
                    ...
                    <div className="flex items-center">
                      ...
                      <div className="relative flex-1">
                        <input
                          ...
                          className={`w-full rounded-md border text-sm ${isDarkMode ? 'border-strong bg-elevated text-primary focus:border-accent focus:ring-2 focus:ring-accent' : 'border-strong bg-surface text-primary focus:border-accent focus:ring-2 focus:ring-accent'} p-2 outline-none`}
                        />
                        ...
                        {modifiedProviders.has(providerId) && !providersFromStorage.has(providerId) && (
                          <button
                            ...
                            className={`absolute right-2 top-1/2 -translate-y-1/2 ${
                              isDarkMode ? 'text-tertiary hover:text-secondary' : 'text-secondary hover:text-primary'
                            }`}
                      ...
                      <div className="flex flex-col">
                        <div className="flex items-center">
                          ...
                          <input
                            ...
                            className={`flex-1 rounded-md border text-sm ${isDarkMode ? 'border-strong bg-elevated text-primary focus:border-accent focus:ring-2 focus:ring-accent' : 'border-strong bg-surface text-primary focus:border-accent focus:ring-2 focus:ring-accent'} p-2 outline-none`}
                          />
                        </div>
                      </div>
                    )}
                    ...
                    {(providerConfig.type as ProviderTypeEnum) === ProviderTypeEnum.AzureOpenAI && (
                      <div className="flex items-start">
                        <label
                          ...
                          className={`w-20 pt-2 text-sm font-medium ${isDarkMode ? 'text-secondary' : 'text-primary'}`}>
                          {t('options_models_providers_deployment')}*
                        </label>
                        <div className="flex-1 space-y-2">
                          <div
                            className={`flex min-h-[42px] flex-wrap items-center gap-2 rounded-md border ${isDarkMode ? 'border-strong bg-elevated text-primary' : 'border-strong bg-surface text-primary'} p-2`}>
                            ...
                            {(providerConfig.azureDeploymentNames || []).length > 0
                              ? (providerConfig.azureDeploymentNames || []).map((deploymentName: string) => (
                                  <div
                                    key={deploymentName}
                                    className={`flex items-center rounded-full ${'bg-accent-soft text-accent'} px-2 py-1 text-sm`}>
                                    <span>{deploymentName}</span>
                                    <button
                                      type="button"
                                      onClick={() => removeAzureDeployment(providerId, deploymentName)}
                                      className={`ml-1 font-bold ${'text-accent hover:text-primary'}`}
                            ...
                            <input
                              ...
                              className={`min-w-[150px] flex-1 border-none text-sm 'bg-transparent text-primary' p-1 outline-none`}
                            />
                          </div>
                          <p className={`mt-1 text-xs ${isDarkMode ? 'text-tertiary' : 'text-secondary'}`}>
                            ...
                            <>
                              <div
                                ...
                                {providerConfig.modelNames && providerConfig.modelNames.length > 0 ? (
                                  ...
                                  <span className={`text-xs ${isDarkMode ? 'text-tertiary' : 'text-secondary'}`}>
                    ...
                    {providerConfig.type === ProviderTypeEnum.Ollama && (
                      <div
                        className={`mt-4 rounded-md border ${'border-subtle bg-subtle'} p-3`}>
                        <p className={`text-sm 'text-primary'`}>
                          <strong>
                            {' '}
                            <code
                              className={`rounded italic ${'bg-accent-soft px-1 py-0.5'}`}>
                          ...
                          <a
                            ...
                            className={`ml-1 ${'text-accent hover:text-primary'}`}>
          ...
          <div className="provider-selector-container relative pt-4">
            <Button
              ...
              className={`flex w-full items-center justify-center font-medium ${
                isDarkMode
                  ? 'border-strong bg-accent text-ink hover:opacity-90'
                  : 'border-strong bg-subtle text-primary hover:border-accent'
              }`}>
                      ...
                      <button
                        ...
                        className={`flex w-full items-center px-4 py-3 text-left text-sm ${
                          isDarkMode
                            ...
                            : 'text-accent hover:bg-accent-soft hover:text-primary'
      ...
      <div
        className={`rounded-lg border ${'border-subtle bg-surface'} p-6 text-left`}>
        <h2 className={`mb-4 text-left text-xl font-semibold 'text-primary'`}>
      ...
      <div
        ...
        <p className={`mb-4 text-sm ${isDarkMode ? 'text-tertiary' : 'text-secondary'}`}>
