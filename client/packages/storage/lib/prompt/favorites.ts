...
const defaultFavoritePrompts = [
  {
    title: '🔍 Find Contact Info Safely',
    content: 'Find the public support contact details on this page without exposing sensitive form fields.',
  },
  {
    title: '📊 Summarize Page Privately',
    content: 'Summarize the main content and key takeaways on this page while keeping private data redacted.',
  },
  {
    title: '🛡️ Check Page Security',
    content: 'Inspect the visible page for secure form fields, login inputs, and data protection indicators.',
  },
];
